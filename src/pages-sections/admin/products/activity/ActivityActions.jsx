...
import DownloadActivityReport from "../actions/download/DownloadActivityReport";
...
function BudgetActions({ budget, project, onChanged }) {
  ...
  const canEditActivity = Boolean(
    project?.canEdit ||
      ["admin", "super_admin", "admin_departamento"].includes(resolvedRole)
  );
  return (
    <Box>
      <DownloadActivityReport budget={budget} project={project} />
